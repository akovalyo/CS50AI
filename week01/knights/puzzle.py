...
knowledge3 = And(
    ...
    Biconditional(BKnight,
                  And(Biconditional(AKnight, AKnave), Biconditional(AKnave, Not(AKnave)))
                  ),
    Biconditional(BKnave, 
                  Not(And(Biconditional(AKnight, AKnave), Biconditional(AKnave, Not(AKnave))))
                  ),
